  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        data-aos-delay={200}
      >
        <figure className="relative overflow-hidden rounded-2xl before:absolute before:inset-0 before:-z-10 before:bg-gradient-to-br before:from-gray-900 before:via-green-500/20 before:to-gray-900">
          <Image
          ...
          <span className="relative flex items-center gap-3">
            ...
            >
              ...
              <defs>
                ...
                >
                  <stop stopColor="#74f163" />
                  <stop offset={1} stopColor="#74f163" stopOpacity=".72" />
                </linearGradient>
              </defs>
            </svg>
